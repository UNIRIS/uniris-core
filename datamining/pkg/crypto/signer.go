...
func (s signer) SignValidation(v validating.Validation, pvKey string) (string, error) {
...
func (s signer) SignMasterValidation(v leading.Validation, pvKey string) (string, error) {
	b, err := json.Marshal(v)
	if err != nil {
		return "", err
	}
