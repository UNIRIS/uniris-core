...
func (s mockSigner) SignContractMessageLeadRequest(req *api.ContractMessageLeadRequest, pvKey string) error {
	req.SignatureRequest = "sig"
	return nil
}
...
func (s mockSigner) VerifyContractMessageLeadRequestSignature(pubKey string, req *api.ContractMessageLeadRequest) error {
	return nil
}
func (s mockSigner) VerifyContractMessageStorageRequestSignature(pubKey string, req *api.ContractMessageStorageRequest) error {
	return nil
}
...
func (s mockSigner) SignContractValidationRequestSignature(req *api.ContractValidationRequest, pvKey string) error {
	req.Signature = "sig"
	return nil
}

func (s mockSigner) SignContractMessageValidationRequestSignature(req *api.ContractMessageValidationRequest, pvKey string) error {
	req.Signature = "sig"
	return nil
}

func (s mockSigner) SignContractStorageRequestSignature(req *api.ContractStorageRequest, pvKey string) error {
	req.Signature = "sig"
	return nil
}
func (s mockSigner) SignContractMessageStorageRequestSignature(req *api.ContractMessageStorageRequest, pvKey string) error {
	req.Signature = "sig"
	return nil
}
