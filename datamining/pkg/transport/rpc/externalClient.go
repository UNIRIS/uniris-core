...
type ExternalClient interface {
	...
	GetTransactionStatus(ip string, addr string, txHash string) (string, error)
}
...
func (c externalClient) GetTransactionStatus(ip string, addr string, txHash string) (string, error) {
