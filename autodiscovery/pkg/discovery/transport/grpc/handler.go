...
func (s GrpcHandler) Synchronize(ctx context.Context, req *protobuf.SynRequest) (*protobuf.SynAck, error) {
...
func (s GrpcHandler) Acknowledge(ctx context.Context, req *protobuf.AckRequest) (*empty.Empty, error) {
