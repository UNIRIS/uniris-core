...
//NewPeerMonitor creates a new peer monitor system
func NewPeerMonitor(privateNetwork bool, privateIface string) discovery.PeerMonitor {
	return peerMon{privateNetwork, privateIface}
}
...
func (i peerMon) GeoPosition() (lon float64, lat float64, err error) {
...
func (i peerMon) CPULoad() (string, error) {
	var cmd *exec.Cmd
...
func (i peerMon) FreeDiskSpace() (float64, error) {
...
func (i peerMon) IP() (net.IP, error) {
	if i.privateNetwork {
