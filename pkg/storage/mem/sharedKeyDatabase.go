...
//SharedKeyDatabase is a shared keys database in memory
type SharedKeyDatabase struct {
...
//NewSharedKeyDatabase creates a shared database in memory
func NewSharedKeyDatabase() SharedKeyDatabase {
...
func (db SharedKeyDatabase) EmitterCrossKeypairs() ([]shared.EmitterCrossKeyPair, error) {
	return db.emitterCrossKeys, nil
}

//FirstEmitterCrossKeypair retrieves the first public key
func (db SharedKeyDatabase) FirstEmitterCrossKeypair() (shared.EmitterCrossKeyPair, error) {
	return db.emitterCrossKeys[0], nil
}

//FirstCrossKeysNode retrieve the first shared crosskeys for the nodes
func (db SharedKeyDatabase) FirstCrossKeysNode() (shared.NodeCrossKeyPair, error) {
	return db.nodeCrossKeys[0], nil
}

//LastNodeCrossKeypair retrieve the last shared crosskeys for the nodes
func (db SharedKeyDatabase) LastNodeCrossKeypair() (shared.NodeCrossKeyPair, error) {
...
func (db SharedKeyDatabase) AuthorizedNodesPublicKeys() ([]string, error) {
