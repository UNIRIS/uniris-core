...
// 	WriteReachableNode(publicKey []byte) error

// 	//WriteUnreachableNode defines a node by its public key as unreachable
// 	WriteUnreachableNode(publicKey []byte) error
// }
...
// 	FindByPublicKey(publicKey []byte) (Node, error)
// }
...
// func NewNode(ip net.IP, port int, pubK []byte, status NodeStatus, cpu string, disk float64, ver string, p2pFactor int, reachNumbers int, lat float64, lon float64, patch GeoPatch, isReachable bool) Node {
// 	return Node{
// 		ip:                   ip,
// 		port:                 port,
// 		publicKey:            pubK,
